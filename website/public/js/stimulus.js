...
// stimulus/controllers/hello_controller.js
...
// stimulus/utils/status-messages.js
function showLoadingMessage(targetElement) {
  resetMessageClasses(targetElement);
...
function showSuccessMessage(targetElement, message) {
  resetMessageClasses(targetElement);
...
// stimulus/controllers/login_controller.js
...
__publicField(login_controller_default, "targets", ["email", "password", "statusMessage", "submitButton"]);
